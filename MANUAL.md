# Manual Setup Steps for Minions Conversations
...
Go to **GitHub → mxn2020/minions-conversations → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-conversations` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-conversations-web`
- **GitHub repo**: `mxn2020/minions-conversations`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `conversations.minions.wtf`

### Documentation
- **Netlify site name**: `minions-conversations-docs`
- **GitHub repo**: `mxn2020/minions-conversations`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `conversations.minions.help`

### Blog
- **Netlify site name**: `minions-conversations-blog`
- **GitHub repo**: `mxn2020/minions-conversations`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `conversations.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `conversations.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `conversations.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `conversations.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-conversations/sdk`](https://www.npmjs.com/package/@minions-conversations/sdk)
- CLI: [`@minions-conversations/cli`](https://www.npmjs.com/package/@minions-conversations/cli)
...
Your package: [`minions-conversations`](https://pypi.org/project/minions-conversations/)
...
| Item | Value |
|------|-------|
| Project | `minions-conversations` |
| SDK (npm) | `@minions-conversations/sdk` |
| CLI (npm) | `@minions-conversations/cli` |
| Python (PyPI) | `minions-conversations` |
| GitHub | `github.com/mxn2020/minions-conversations` |
| Docs domain | `conversations.minions.help` |
| Blog domain | `conversations.minions.blog` |
| App domain | `conversations.minions.wtf` |
