...
/**
 * @minions-conversations/cli — CLI for Minions Conversations
 *
...
import { customTypes } from '@minions-conversations/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Conversations'));
        console.log(chalk.dim('Email threads, reply parsing, intent detection, and escalation triggers'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-conversations/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-conversations/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-conversations')}`);
